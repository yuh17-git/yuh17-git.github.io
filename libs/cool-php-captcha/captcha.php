...
class SimpleCaptcha {
    ...
    public $GdFgColor = null;
    public $GdBgColor = null;
    public $GdShadowColor = null;
    public $textFinalX = 0;
    ...
    protected function WaveImage() {
        ...
        for ($i = 0; $i < ($this->width * $this->scale); $i++) {
            imagecopy(
                ...
                $this->im,
                $i - 1,
                intval(sin($k + $i / $xp) * ($this->scale * $this->Xamplitude)),
                $i,
                0,
                1,
                intval($this->height * $this->scale)
            );
        }
        ...
        for ($i = 0; $i < ($this->height * $this->scale); $i++) {
            imagecopy(
                $this->im,
                $this->im,
                intval(sin($k + $i / $yp) * ($this->scale * $this->Yamplitude)),
                $i - 1,
                0,
                $i,
                intval($this->width * $this->scale),
                1
            );
        }
    }
